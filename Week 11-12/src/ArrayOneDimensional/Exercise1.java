...
public class Exercise1 {
	...
	public static void main(String[] args) {
		...
		// declare and array of 15 element of type integer
		...
		// set the value of the nineth element of the array alpha to the sum of the sixth and 13 element of the array alpha
